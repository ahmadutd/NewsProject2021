...
namespace AllNews.Data.Repositores
{
    ...
    {
        public PhotoRepository(AllNewsDbContext context):base(context)
        {

        }

        public IEnumerable<Photo> GetPhotos(bool sortDesc = true, int? countItem = null, string culture = null)
        {
            if (countItem != null)
            {
                if (sortDesc)
